...
class HBNBCommand(cmd.Cmd):
    """ Contains functionality for the HBNB"""
    ...
    def preloop(self):
     ...
     def precmd(self, line):
        ...
        (Brackets optional fields in usage)
        """
        _cmd = _cls = _id = _args = ''
    ...
    def do_all(self, args):
        ...
        if args:
            ...
            if args not in HBNBCommand.classes:
                print("** class doesn't exist **")
                return
            for c, w in storage._FileStorage__objects.items():
                if c.split('.')[0] == args:
    ...
    def do_update(self, args):
        """ Updates certain object with new"""
        ...
        new_dict = storage.all()[ky]

        for h, att_name in enumerate(args):
            if (h % 2 == 0):
                att_val = args[i + 1]
                if not att_name:
    ...
    def help_update(self):
        """ Help information for class update """
